...
<html lang="pt-BR">
  ...
  <body style="padding: 20px;"  bgsound src="/bryan/musicabolo.wma" loop="15">
    <header>
      <section class="sec-nome-bolo">
        <img src="/bryan/bolofofos2.png" style="width: 400px; margin-top: 20px;" alt="Imagem nome bolofofos">
      </section>
    </header>
    ...
    <main class="main-bryan">
      ...
      <section style="margin-top: 70px;">
        <img class="bb" src="/bryan/bolofofos1.png" style="width: 200px;" alt="Imagem figuras bolofofos">
      </section>
      <section>
        <img class="yy" src="/bryan/bryanFoto.png" style="width: 230px;" alt="Imagem de bryan">
      </section>
      </div>
      <div classe="div-mapa">
...
<section class="sec-nome-boloo">
        <img src="/bryan/bolofofos2.png" style="width: 400px; margin: 20px 0 20px 0;" alt="Imagem nome bolofofos">
      </section>
</footer>
  </body>
</html>
